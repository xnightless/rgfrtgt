...
<ul class="navbar">
    <li class="nav-item"><a onclick="frame.src='/index.html';">Home</a></li>
    <li class="nav-item"><a onclick="frame.src='/games.html';">Games</a></li>
    <li class="nav-item"><a onclick="frame.src='/apps.html';">Apps</a></li>
    <li class="nav-item"><a onclick="frame.src='/tabs.html';">tabs</a></li>
    <li class="nav-item"><a onclick="frame.src='/settings.html';">settings</a></li>
</ul>
...
window.addEventListener('load', function () {
  ...
  if (currentUrl !== "about:blank" && !sessionStorage.getItem('tabOpened')) {
    if (window.open('', '_blank')) {
      ...
      alert("Please enable pop-ups for auto about:blank cloaking to work.");
...
<script>
  window.addEventListener('keydown', (event) => {
    ...
    if (keysPressed) {
      ...
      </script><div id="gamerdov" class="game-diver">
    <!--    lol -wave    -->
</div>